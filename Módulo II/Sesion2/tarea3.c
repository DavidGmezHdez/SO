...
//CAMBIO DE PERMISOS
if(stat("archivo1",&atributos) < 0) {  //Guarda el estado del archivo y sus atributos en atributos
	printf("\nError al intentar acceder a los atributos de archivo1");
	perror("\nError en lstat");
	exit(EXIT_FAILURE);
}
if(chmod("archivo1", (atributos.st_mode & ~S_IXGRP) | S_ISGID) < 0) { //Con el and le quita o le da los flahs
